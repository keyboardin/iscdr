/**
* 모듈명 : AES256Cipher
* 설명 : AES256를 사용해서 암호화 및 복호화(비교)를 수행
**/
...
public class AES256Util {
    ...
    /*public static void main(String[] args) {
    	try {
    		System.out.println(encrypt("admin", "com.insung.isup.key")); 
    		System.out.println(decrypt("AeZVplDBIxtMQ3F6xegT/g==", "com.insung.isup.key"));
