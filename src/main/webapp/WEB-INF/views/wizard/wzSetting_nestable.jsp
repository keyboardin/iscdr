				                    ...
				                    <div class="row">
				                    	...
				                    	<div class="col-lg-8">
	                                            ...
	                                            <div class="col-md-10">
						                        	<div class="row" style="padding-top:8px;">
						                            	<div class="col-md-2" style="padding-right:5px;">
						                               		<div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" id="DD" name="rdoDateType" checked="checked">
														...
														<div class="col-md-2">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" id="MM" name="rdoDateType">
                                                                <label class="custom-control-label" for="MM">월별</label>
                                                            </div>
                                                        </div>
														<div class="col-md-2">
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" id="HH" name="rdoDateType">
				                    		...
				                    		<div class="row py-3" id="where_datetime">
												<div class="col-md-2">
                                                	<div class="custom-control mb-1 text-center">
	                                            ...
	                                            <div class="col-md-4">
		                                            <div class="input-daterange input-group">
						                                ...
						                                <select class="form-control" id="from_time" style="width:70px;"></select>
						                            </div>
						                        </div>
						                        <div class="col-md-4">
						                            <div class="input-daterange input-group">
						                                ...
						                                <select class="form-control" id="to_time" style="width:70px;"></select>
						                            </div>
						                        </div>
						                    </div>
						                    <div class="row py-3" id="where_maintel">
                                                <div class="col-md-2">
                                                	<div class="custom-control mb-1 text-center">
	                                                    <label class="form-label pt-2">대표번호</label>
	                                                </div>
	                                            </div>
	                                            <div class="col-md-8">
				                    ...
				                    <div class="row">
				                    	...
				                    	<div class="col-md-4">
				                    		...
				                    		<div class="row p-sm-3">
												<div class="frame-wrap mb-0 w-100">
													<div class="card">
														<div class="card-body bg-info-50">
...
var Service = {
	...
	requestTableColumnList : function(table_name) {
		...
		Common.ajaxJSON(ajaxParam, function(data) {
			...
			$.each(data.resultList, function(index, item) {
				inColumnHTML += "<li class='ui-state-default'>"+item.column_type+"</li>";
				nestable_html += '<li class="dd-item" data-id="'+item.column_name+'" id="'+item.column_name+'">';
				nestable_html += '	<div class="dd-handle">'+item.column_type+'</div>';
				nestable_html += '</li>';
			});
			...
			$("#nestable").html(nestable_html);
		 	$("#nestable2").html('<ol class="dd-list"><li class="dd-item" data-id=""></li></ol>');
			//setNestable();
		});
	}
	, //requestWzPopup
	...
	requestMainTelList : function(){
		...
		Common.ajaxJSON(ajaxParam, function(data) {
			$.each(data.resultList, function(index, item) {
				...
				$('#selectMainTel').append("<option value='"+item.main_tel+"'>"+item.main_tel+"</option>");		
			});
		});
	},
