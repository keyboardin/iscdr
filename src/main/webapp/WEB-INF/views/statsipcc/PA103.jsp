							...
							<table id="dataTable" class="table table-bordered table-hover w-100">
	                        	<thead>
									<tr>	
										...
										<th class="text-center" style="width:15%;">대표번호</th>   
										<th class="text-center">총인입콜</th>   
										...
										<th class="text-center" style="width:9%;">서비스레벨(20s)</th>   
										<th class="text-center">포기콜</th>   
										
										<th class="text-center">포기율(%)</th>   
										<th class="text-center">콜백</th>   
										<th class="text-center" style="width:9%;">평균응답</th>   
										<th class="text-center" style="width:9%;">평균포기</th>   
									</tr>
	                        	</thead>
	                        </table> 
						</div>                                            
...
$(function() { 
	...
	strUrl += '?rid='+encodeURIComponent('PA103');
	...
	var dataTable = $('#dataTable').dataTable({
    	...
    	"responsive": true,
	  	...
	  	"columns": [
	    	...
	    	{ 	"data":"MainTel",			className:"text-right"	}, 
