					...
					<div class="panel-content"> 
						...
						<div class="frame-wrap">
							<table id="dataTable" class="table table-bordered table-hover w-100">
	                        	<thead>
									<tr>	
										<th class="text-center" style="width:17%;">스킬그룹</th> 
										...
										<th style="width:9%;"  class="text-center">서비스레벨(20s)</th>   
										<th class="text-center">포기콜</th>   
										<th class="text-center">포기율(%)</th>										
										<th style="width:9%;" class="text-center">평균응답</th>   
										
										<th style="width:9%;" class="text-center">평균포기</th>   
									</tr>
	                        	</thead>
	                        </table> 
						</div>                                            
...
$(function() { 
	...
	strUrl += '?rid='+encodeURIComponent('PA104');
	...
	var dataTable = $('#dataTable').dataTable({
    	...
    	"responsive": true,
	  	...
	  	"columnDefs": [  
			...
			{ 	"targets":[2], "searchable":false, "sortable":false, "visible":false	},
	  	...
	  	"columns": [
	    	{ 	"data":"SkillGroupSkillTargetNameKor", 	className:"text-right"		},	     	
	...
	function updateResultTable(){
		...
		if(dttype=='H'){
			dataTable.api().column(1).visible(false);
			dataTable.api().column(2).visible(true);
		} else if(dttype=='DH') {
