							...
							<table id="dataTable" class="table table-bordered table-hover w-100">
	                        	<thead>
									<tr>	
										...
										<th class="text-center" style="width: 8%;">팀명</th> 
...
$(function() { 
	...
	strUrl += '?rid='+encodeURIComponent('PA107');
	...
	var dataTable = $('#dataTable').dataTable({
    	...
    	"responsive": true,
	  	...
	  	"columns": [
	    	...
	    	{ 	"data":"AgentTeamName", 	className:"text-center"		},	     	
	    	{ 	"data":"AgentName",			className:"text-center"		}, 
	    	{ 	"data":"AgentID",			className:"text-center"		},
