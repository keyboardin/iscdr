...
$(function() { 
	...
	function createWidget(){
		...
		Common.ajaxJSON(ajaxParam, function(data) {  
			...
			var bar_chart = Chart.drawC3BarChart("widget", widget_data, widget_colors, 10);
