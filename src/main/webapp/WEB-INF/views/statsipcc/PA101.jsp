					...
					<div class="panel-content"> 
						...
						<div class="frame-wrap">
							<table id="dataTable" class="table table-bordered table-hover w-100">
	                        	<thead>
									<tr>	
										<th class="text-center" rowspan="2" style="vertical-align: middle;width:8%;">일자</th> 
										<th class="text-center" rowspan="2" style="vertical-align: middle;width:4%;">시간</th> 
										<th class="text-center" rowspan="2" style="vertical-align: middle;">총건수</th> 
										<th class="text-center" colspan="12">인바운드</th>   
										<th class="text-center" colspan="3">아웃바운드</th>   
									</tr>
									<tr>	
										<th class="text-center">인입콜</th>   
										<th class="text-center">ARS처리콜</th>   
										<th class="text-center">ARS처리율</th>   
										
										<th class="text-center">요청콜</th>   
										<th class="text-center">응답콜</th>   
										<th class="text-center">응답율(%)</th>   
										<th class="text-center" style="width:7%">서비스레벨(20s)</th>   
										<th class="text-center">포기콜</th>   
										
										<th class="text-center">포기율(%)</th>   
										<th class="text-center">콜백</th>   
										<th class="text-center">평균응답</th>   
										<th class="text-center">평균포기</th>   
										<th class="text-center">OB시도</th>   

										<th class="text-center">OB통화</th>   
										<th class="text-center">평균통화</th>   
									</tr>
	                        	</thead>
	                        </table> 
						</div>                                            
...
$(function() { 
	...
	strUrl += '?rid='+encodeURIComponent('PA101');
	...
	var dataTable = $('#dataTable').dataTable({
    	...
    	"responsive": true,
	  	...
	  	"columns": [
	    	...
	    	{ 	"data":"TotCall",			className:"text-right"	}, 
	    	{ 	"data":"InCall",			className:"text-right"	}, 
	    	{ 	"data":"ArsEndCall",		className:"text-right"	},

	    	{ 	"data":"ArsEndCallRate",	className:"text-right"	},
			{ 	"data":"AgtReqCall",		className:"text-right" 	},
	    	{ 	"data":"AgtAnsCall",		className:"text-right" 	},
	    	{ 	"data":"AgtAnsCallRate",	className:"text-right" 	},
	    	{ 	"data":"SvcLevelRate",		className:"text-right" 	},
	    	
			{ 	"data":"AbnCall",			className:"text-right"	},
			{ 	"data":"AbnCallRate",		className:"text-right"	},
	    	{ 	"data":"CallBackCall",		className:"text-right"	},
	    	{ 	"data":"AgtAnsTimeAvg",		className:"text-right"	},
	    	{ 	"data":"AbnTimeAvg",		className:"text-right"	},
	    	
			{ 	"data":"ObTryCall",			className:"text-right"	},
	    	{ 	"data":"ObAnsCall",			className:"text-right"	},
			{ 	"data":"ObTalkTimeAvg",		className:"text-right"	}
	    ],
	    //"order":[0,"asc"],
	    "ordering":false,
