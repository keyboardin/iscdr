							...
							<table id="dataTable" class="table table-bordered table-hover w-100">
	                        	<thead>
									<tr>
										...
										<th class="text-center" rowspan="2" style="vertical-align: middle;">요청콜</th>   
										<th class="text-center" colspan="3">포기콜</th>   
										<th class="text-center" rowspan="2" style="vertical-align: middle;">포기율</th>  
										<th class="text-center" colspan="7">포기콜 대기시간 분포</th>   
										<th class="text-center" rowspan="2" style="vertical-align: middle;">평균포기</th>   
										<th class="text-center" rowspan="2" style="vertical-align: middle;">무시콜</th>   
									</tr>
									<tr>
										<th class="text-center">합계</th>   
										<th class="text-center">큐포기</th>
...
$(function() { 
	...
	strUrl += '?rid='+encodeURIComponent('PA105');
	...
	var dataTable = $('#dataTable').dataTable({
    	...
    	"responsive": true,
	  	...
	  	"columns": [
	    	...
	    	{ 	"data":"AbnQueueCall",	className:"text-right" 		},
	    	
	    	{ 	"data":"AgtAbnRingCall",className:"text-right" 		},
	    	{ 	"data":"AbnCallRate",	className:"text-right"		},
	    	{ 	"data":"Abn10sCall",	className:"text-right" 		},
	    	{ 	"data":"Abn20sCall",	className:"text-right" 		},
	    	{ 	"data":"Abn30sCall",	className:"text-right"		},
	    	
	    	{ 	"data":"Abn40sCall",	className:"text-right" 		},
	    	{ 	"data":"Abn50sCall",	className:"text-right" 		},
	    	{ 	"data":"Abn60sCall",	className:"text-right"		},
	    	{ 	"data":"Abn60sOverCall",className:"text-right"		},
	    	{ 	"data":"AbnTimeAvg",	className:"text-right"		},
	    	
	    	{ 	"data":"AgtAbnRonaCall",className:"text-right"		}
	    ],	
	    //"order":[0,"asc"],
	    "ordering":false,
