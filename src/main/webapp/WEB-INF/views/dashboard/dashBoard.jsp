...
<div id="main" role="main">
	<div id="ribbon">
		<ol class="breadcrumb">
			<li><i class="fa-fw fa fa-home"></i> Home</li><li id="page_title"></li>
		</ol>
	</div>
							...
							<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<div id="sin-chart" class="chart"></div>
...
<script src="${contextpath}/static/SmartAdmin/js/plugin/jqgrid/jquery.jqGrid.min.js"></script>
<script src="${contextpath}/static/SmartAdmin/js/plugin/jqgrid/grid.locale-en.min.js"></script>
<script src="${contextpath}/static/SmartAdmin/js/app.min.js"></script>
<script src="${contextpath}/static/common/js/common.js"></script> 
<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->


		<!-- IMPORTANT: APP CONFIG -->
		<script src="${contextpath}/static/SmartAdmin/js/app.config.js"></script>

		<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js"></script> 

		<!-- BOOTSTRAP JS -->
		<script src="${contextpath}/static/SmartAdmin/js/bootstrap/bootstrap.min.js"></script>

		<!-- CUSTOM NOTIFICATION -->
		<script src="${contextpath}/static/SmartAdmin/js/notification/SmartNotification.min.js"></script>

		<!-- JARVIS WIDGETS -->
		<script src="${contextpath}/static/SmartAdmin/js/smartwidgets/jarvis.widget.min.js"></script>

		<!-- EASY PIE CHARTS -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

		<!-- SPARKLINES -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/sparkline/jquery.sparkline.min.js"></script>

		<!-- JQUERY VALIDATE -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/jquery-validate/jquery.validate.min.js"></script>

		<!-- JQUERY MASKED INPUT -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/masked-input/jquery.maskedinput.min.js"></script>

		<!-- JQUERY SELECT2 INPUT -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/select2/select2.min.js"></script>

		<!-- JQUERY UI + Bootstrap Slider -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>

		<!-- browser msie issue fix -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>

		<!-- FastClick: For mobile devices -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/fastclick/fastclick.min.js"></script>
		...
		<script src="${contextpath}/static/SmartAdmin/js/speech/voicecommand.min.js"></script>

		<!-- SmartChat UI : plugin -->
		<script src="${contextpath}/static/SmartAdmin/js/smart-chat-ui/smart.chat.ui.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/smart-chat-ui/smart.chat.manager.min.js"></script>

		<!-- PAGE RELATED PLUGIN(S) -->

		<!-- Flot Chart Plugin: Flot Engine, Flot Resizer, Flot Tooltip -->
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.cust.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.resize.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.fillbetween.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.orderBar.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.pie.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.time.min.js"></script>
		<script src="${contextpath}/static/SmartAdmin/js/plugin/flot/jquery.flot.tooltip.min.js"></script>
